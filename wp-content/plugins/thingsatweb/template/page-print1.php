...
<div style="display:flex; height:915px;">
    ...
    <?php //if (!empty($product->get_description())) : ?>
        <!-- product description -->
        <div style="margin-left: 50px; height: 245px; margin-top: -40px; margin-bottom:20px;  width:90%;">
            <p style="font-size: 11px; font-family: 'Poppins', sans-serif; ">
                <?php
 ...
 foreach ($categories as $categoryId) {
    // $parentquery = "SELECT taxonomy.description FROM tsm_terms as term 
    ...
    // $parentSlug = $wpdb->get_var($parentquery);
                $childquery = "SELECT taxonomy.description FROM tsm_terms as term 
                                INNER JOIN tsm_term_taxonomy as taxonomy ON term.term_id = taxonomy.term_id
                                WHERE term.term_id = $categoryId AND taxonomy.parent != 0";
 ...
 //print_r($cleaned_result);
    ...
    <?php 
        ...
        if (isset($formatted_attributes['Weight capacity']) || isset($formatted_attributes['Extension']) || isset($formatted_attributes['Colour'])
        || isset($formatted_attributes['Load metod']) || isset($formatted_attributes['Type of load']) || isset($formatted_attributes['Loading'])
        || isset($formatted_attributes['Load Way']) || isset($formatted_attributes['Picking Method']) || isset($formatted_attributes['Short or long side handled']) 
        || isset($formatted_attributes['Shelf lock']) || isset($formatted_attributes['Number of shelves']) 
        ) :
        ?>
        ...
        ?>
            ...
            <div style="width: 100%; border: 1px solid; padding: 2px; display: flex; align-items: center; margin-bottom: -1px; padding-left: 20px; padding-right: 20px; border-color: #374151; display: flex; justify-content: center; align-items: center; position: relative; height: 150px;"> -->
                    ...
                    <!-- <span style="text-align: center;  font-family: 'Poppins', sans-serif; font-size: 12px; color: black; font-weight: normal; width: 100%; cursor: pointer; display: inline-block; max-width: 100%; overflow-wrap: break-word; word-wrap: break-word; hyphens: auto; height: 42px; padding-bottom:5px;"> -->
                        <?php
                        $keyvalue = explode(', ', $formatted_attributes[$attributeKey]);
...
if (
    ...
    || isset($formatted_attributes['Product Weight']) || isset($formatted_attributes['Quantity at pallet'])
    ...
    <!-- <span style=" margin-left:-50px; width: 1920px; margin-top: -30px; display: flex;padding-top:10px;  padding-bottom:10px; background-color: #CC071D;"></span> -->
    <!-- </div> -->
    <div style="display:flex; height:972px;">

        <?php
     
        // if ((isset($meta['article_price']['product_diagram_file']['url']) && !empty($meta['article_price']['product_diagram_file']['url'])) ||   (isset($meta['article_price']['product_diagram_file2']['url']) && !empty($meta['article_price']['product_diagram_file2']['url'])) ||   (isset($meta['article_price']['product_diagram_file3']['url']) &&  !empty($meta['article_price']['product_diagram_file3']['url']))) : ?>
            ...
            <div style="height: 530px;">
                <?php if (isset($meta['article_price']['product_diagram_file']['url']) && !empty($meta['article_price']['product_diagram_file']['url'])) {    
                    ...
                    <div style="margin-left:70px; width:450px; height:390px; overflow: hidden; margin-top: -40px;">
                        <?php
                            ...
                            echo '<img src="' . $base64 . '" alt="Manual" style="margin-bottom:2px; margin-top:2px; width: 100%; height: auto;">';  
                        ?>
                    </div>
                <?php } ?>
                <?php if (empty($meta['article_price']['product_diagram_file']['url'])) {  ?>
                <div style="width:600px; height: 150px;  margin-top:10px; padding-bottom:30px;margin-top: -40px;">
                <?php }elseif (!empty($meta['article_price']['product_diagram_file']['url'])) {  ?>
                <div style="width:600px; height: 150px;  margin-top:10px; padding-bottom:30px;">
                <?php } ?>   
                        <?php if (isset($meta['article_price']['product_diagram_file2']['url']) && !empty($meta['article_price']['product_diagram_file2']['url'])) {    
                            ...
                            <div style="float:left; margin-left: 30px;">
                                    ...
                                    // echo '<img src="' . $base64 . '" alt="Manual" 
                                    // style="margin-bottom:9px; margin-left:50px; margin-right:10px; width:500px; height:300px;">';
                                    echo '<img src="' . $base64 . '" alt="Manual" style="margin-bottom:2px; margin-top:2px; width:80%; height: auto;">';  
                                    ?>                
                            </div>
                        <?php } ?>
                        <?php if (isset($meta['article_price']['product_diagram_file3']['url']) && !empty($meta['article_price']['product_diagram_file3']['url'])) { ?>
                            <?php if (empty($meta['article_price']['product_diagram_file2']['url'])) {  ?>
                                <div style="margin-left: 50px; float:left; "> 
                                    ...
                                    // echo '<img src="' . $base64 . '" alt="Manual" 
                                    // style="margin-bottom:9px; margin-left:50px; margin-right:10px; width:500px; height:300px;">';
                                    echo '<img src="' . $base64 . '" alt="Manual" style="margin-bottom:2px; margin-top:2px; width:30%;  height: auto;">';  
                                    ?> 
                                </div>
                                ...
                                <div style="margin-left:500px; float:left; "> 
                                    ...
                                    // echo '<img src="' . $base64 . '" alt="Manual" 
                                    // style="margin-bottom:9px; margin-left:50px; margin-right:10px; width:500px; height:300px;">';
                                    echo '<img src="' . $base64 . '" alt="Manual" style="margin-bottom:2px; margin-top:2px; width:150%;  height: auto;">';  
                                    ?>  
                                </div>
                                <?php } ?>
                        <?php } ?>
        ...
        <?php if (
            ...
            <div style="height:150px; margin-left: -35px; ">
                <span class="text-[12px] text-black font-bolder text-left flex" style="width:100%;margin-left:50px; direction: flex; font-size: 14px; font-family: 'Poppins', sans-serif; font-weight: bold; padding-top: 0px; padding-bottom: 5px; ">
                    <?php if ($lang == "en") { ?> WEIGHT CAPACITY SUPPORT BEAM <?php } elseif ($lang == "sv") { ?> Viktkapacitet stödbalk <?php } ?>
                </span>
                <div style="margin-top:-10px;">
                <div style="margin:20px; padding:10px; width:85%; border: 1px solid #D1D5DB;  margin-left:52px; background-color: #F3F4F6; font-family: 'Poppins', sans-serif;">
                    <span class="text-[8px] text-black font-normal text-left flex" style="width:150%;direction: flex; font-size: 12px;  font-weight:600;  padding-top: 5px; padding-left: 10px; padding-bottom: 5px;font-family: 'Poppins', sans-serif; ">
                        <?php if ($lang == "en") { ?> MINIMUM WEIGHT CAPACITY / SUPPORT BEAMS PAIR <?php } elseif ($lang == "sv") { ?> Minsta viktkapacitet stödbalk <?php } ?>
                    </span>
                    <table style="margin:10px; width:98%; border-collapse: collapse;">
                        <tr style="background-color:#575656;  font-size: 10px; text-align: center; font-weight: bold; color:white; font-family: 'Poppins', sans-serif; ">
                            <?php if (isset($formatted_attributes['WCSB 1 pallet'])) : ?>
                                <td style="padding-top:5px; padding-bottom:5px; border: 1px solid #000;">
                                    1 PALLET
                                </td>
                            <?php endif; ?>
                        ...
                        <tr>
                            <?php if (isset($formatted_attributes['WCSB 1 pallet'])) : ?>
                                ...
                                <td style="text-align: center; padding: 4px;font-family: 'Poppins', sans-serif;font-size: 12px; font-weight: normal;  border:1px solid black; text-transform: uppercase;">
                                    <?php
                    ...
                    <span style="width:100%;font-family: 'Poppins', sans-serif; font-size:10px; padding-left: 10px; ">
                        <?php if ($lang == "en") { ?> OBS! ONLY ONE UNIT PER SECTION MAY BE EXTRACTED AT A TIME! <?php } elseif ($lang == "sv") { ?> OBS! Bara en enhet kan vara i utdraget läge samtidigt. <?php } ?>
                    </span>
                </div>
                </div>
            </div>
             ...
             } elseif ($lang == "sv") 
             {
                ...
                foreach ($attributesToDisplay as $attributeKey => $attributeData) {
                    if (isset($formatted_attributes[$attributeKey])) {
                        ...
                        echo '<div style="width:2.5%; align-items: center;  display: inline-block; box-sizing: border-box; margin-left:52px; ' . $divHeight . '">';
                ...
                ?>
                     ...
                     <div style="width: 100%; border: 1px solid; padding: 2px; display: flex; align-items: center; margin-bottom: -1px; padding-left: 20px; padding-right: 20px; border-color: #374151; display: flex; justify-content: center; align-items: center; position: relative; height: 150px;"> -->
                        ...
                        <span style="position: absolute;font-family: 'Poppins', sans-serif; left: 0; right: 0; text-align: center; font-size: 8px; color: black; font-weight: normal; display: flex; justify-content: center; width: 100%;  height: 5px;">
                            <?php
                            // $keyvalue = str_replace(' ', '', $formatted_attributes[$attributeKey]);
                            // echo $keyvalue;
                            $keyvalue = explode(', ', $formatted_attributes[$attributeKey]);
                            echo implode(' | ', $keyvalue);
                            ?>
        ...
        if ((isset($formatted_attributes['Product Weight']))  || (isset($formatted_attributes['Quantity at pallet'])) ||
            ...
            (isset($formatted_attributes['Quantity in the Package'])) || (isset($formatted_attributes['Package Size']))
             ...
             <div style="height:115px; margin-left: -35px; ">
                <div style="width:800px; max-width:40%; padding-bottom:10px; ">
                    <span style="font-size:14px; font-family: 'Poppins', sans-serif; font-weight:bold;  margin-left:50px;">
