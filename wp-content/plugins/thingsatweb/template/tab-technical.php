...
$keysToCheck = array_column($technicalsupport, 'attibutename');
$matchFound = false;
    ...
    <div class="w-full flex flex-wrap">
      <?php foreach ($attributesToDisplay as $attributeKey => $attributeData) {
              if (isset($formatted_attributes[$attributeKey])) { 
                $widthvalue = explode(', ',$formatted_attributes[$attributeKey]);
...
//echo str_replace('-', ' ', $formatted_attributes[$attributeKey]);
