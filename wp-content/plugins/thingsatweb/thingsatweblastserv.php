...
function my_plugin_menu()
{
    ...
    // add_submenu_page("product_customise", "Exporting", "Exporting", "manage_options", "product_exporting", "productExportingPage");
...
function productExportingPage()
{
    if (!current_user_can('manage_options')) {
        wp_die(__('You do not have sufficient permissions to access this page.'));
    }

    include_once(__DIR__ . '/template/page-exporting.php');
}
