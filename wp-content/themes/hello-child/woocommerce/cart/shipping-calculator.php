...
<form class="woocommerce-shipping-calculator" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
	...
	<?php printf( '<a href="#" class="shipping-calculator-button !no-underline bg-red-600 hover:bg-black text-white rounded-full font-semibold hover:text-white text-xs !py-1 !px-3">%s</a>', esc_html( ! empty( $button_text ) ? $button_text : __( 'Calculate shipping', 'woocommerce' ) ) ); ?>
	...
	<section class="shipping-calculator-form" style="display:none;">
		...
		<p><button name="calc_shipping" value="1" class="bg-red-600 hover:bg-black text-white rounded-full font-semibold hover:text-white text-xs !py-1 !px-3"><?php esc_html_e( 'Update', 'woocommerce' ); ?></button></p>
