...
// icl_register_string('TAW_TEXT_DOMAIN','Your contact details','Your contact details');
// icl_register_string('TAW_TEXT_DOMAIN','Fill your cart with amazing items','Fill your cart with amazing items');
// icl_register_string('TAW_TEXT_DOMAIN','Du har inga offertartiklar','Du har inga offertartiklar');

// icl_register_string('woocommerce','Set Color','Set Color');
// icl_register_string('woocommerce','Selected Color','Selected Color');
                                    ...
                                    <li class="py-1 hld_<?php echo $key; ?>">
                                        ...
                                        <ul class="grid grid-cols-3 gap-2 filter-option-container" data-key="<?php echo $key; ?>" id="taw_attr_<?php echo $key; ?>">
                                            ...
                                            ?>
                                                    ...
                                                    ?>
                                                        <li class="mt-3">
                                                            <div data-id="<?php echo $term_id; ?>" data-title="<?php echo $term_name; ?>" style="background:<?php echo $color; ?>" class="taw_attr_option flex flex-col items-center h-[73px] xl:h-[89px] rounded-md border border-gray-700 hover:border-2 hover:border-red-600">
           ...
           ?>
                <div class="lg:mt-2 lg:mb-5 relative">
                    ...
                    <div class="mb-6 mt-4 lg:mb-0 px-5 md:px-9 xl:px-12" id="taw-prod-items-hld" style="position: relative;">
                        ...
                        <button id='taw_filter_item_load_more' style="display:none;"><?php echo __('Load More', 'TAW_TEXT_DOMAIN');
?></button>
                        <!------- bottom- content ------->
                    </div>
                ...
                <div class="fixed bottom-0 w-full lg:hidden" style="z-index:100;">
                    <!-- BOTTOM MEMU CONTENT-->
                    <div id='productfilbottom' class="bottom-menu-content bg-gray-100 p-3" style="box-shadow: 0 -2px 3px -2px #333; bottom:-180px; position:absolute; width:100%;">
                        <?php if ($ee === 0) { ?>
				...
				if (is_array($attributes)) {
                                                ...
                                                foreach ($options as $a) :
                                                    ...
                                                    if (in_array($term_name_lower, $orgele_lower)) {
                                                        ...
                                                        <?php elseif ($display_type == "color_txt") :
                                                            $color = $a['color'] ?? "color"; ?>
                                                            <div class="mt-3 ml-0.5 mr-0.5 md:ml-1.5 md:mr-1.5">
                                                                <div data-id="<?php echo $term_id; ?>" data-title="<?php echo $term_name; ?>" style="background:<?php echo $color; ?>" class="taw_attr_option flex flex-col items-center h-[71px] sm:h-[85px] md:h-[102px] rounded-md border border-gray-700 hover:border-2 hover:border-red-600">
                    ...
                    <!-- BOTTOM MENU -->
                    <div class="w-full grid grid-cols-5 bg-white border" style="box-shadow: 0 -2px 3px -2px #333; z-index:1; position:relative;">
                        <?php
                        ...
                        <script>
                            ...
                            function showHideFilter() {
                                var productfilbottom = jQuery('#productfilbottom');
                                var currentBottom = parseInt(productfilbottom.css('bottom')) || 0;
                                productfilbottom.css('bottom', (currentBottom === -180) ? '50px' : '-180px');
                            }
                        </script>
                    </div>
                </div>
...
<script>
    function toggleproductfilter() {
        ...
        if (productFilterContent.style.bottom === "-180px" || productFilterContent.style.bottom === "") {
            productFilterContent.style.bottom = "0";
        } else {
            productFilterContent.style.bottom = "-180px";
        }
    }
</script>
